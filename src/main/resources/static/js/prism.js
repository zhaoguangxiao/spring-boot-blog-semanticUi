...
!function (e) {
    var t = "(?:\"(?:\"\"|[^\"])*\"(?!\")|'(?:''|[^'])*'(?!'))", a = /\b(?:\d[\da-f]*x|\d+(?:\.\d+)?(?:e[+-]?\d+)?)\b/i,
        ...
        i = [/\/\*[\s\S]*?\*\//, {pattern: /(^\s*|;\s*)\*[^;]*;/m, lookbehind: !0}],
        s = {pattern: RegExp(t), greedy: !0}, r = /[$%@.(){}\[\];,\\]/, o = {
